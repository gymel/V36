...
:f1
cls
echo Die %1. Kategorie bitte: (Ende: x)
if %1 == 1 echo  eigentlich ist es die 2., denn die Sortierkategorie ist die erste!)
if %1 == 1 echo  Dieses Feld wird zugleich als zweites Sortierfeld benutzt)
acreply reply 8
call acantw.bat
echo.
...
echo.
if %REPLY%x == x goto f2
echo 6%1=t%REPLY%    hinter #%F1% >> export.%-K1%pt 
goto f2
